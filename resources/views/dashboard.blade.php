     ...
     <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tr onclick="document.location.href='{{url('')}}/balances/{{$balance->balance_code}}';return false;" class="btnextra">
                <td style="min-width:80px; max-width:80px;"><a href="{{url('')}}/balances/{{$balance->balance_code}}"><div class='balance_cover' style="background:url('{{url('/storage/uploads/covers')}}/{{$balance->cover_name}}') no-repeat center center;
       ...
       <tr class="nohover"> <th style="width:20px;"></th><th style="min-width:80px">Amount</th>
        ...
        <tr onclick="document.location.href='{{url('')}}/balances/{{$recent->mutation->balance->balance_code}}#mut{{$recent->mutation->mutation_count}}';return false;" class="btnextra">
            <td></td>
